...
import com.laptrinhweb.raucuqua.beans.UserGoogleDto;
...
public class LoginGoogleHandler extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        String username = Util.getUserByMail(user.getEmail());
        if(username==null){
            Register.registerAutoID_user(user.getName(),user.getEmail(),"googleAccount",user.getPicture());
        }
        UserAccount ua = UserServices.getInstance().checkLogin(user.getName(),"googleAccount");
